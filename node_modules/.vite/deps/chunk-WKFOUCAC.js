...
var CallbackManager = class _CallbackManager extends BaseCallbackManager {
  ...
  static _configureSync(inheritableHandlers, localHandlers, inheritableTags, localTags, inheritableMetadata, localMetadata, options) {
    ...
    const tracingV2Enabled = isTracingEnabled2();
    ...
    if (verboseEnabled || tracingEnabled) {
      ...
      if (tracingEnabled && !callbackManager.handlers.some((handler) => handler.name === "langchain_tracer")) {
        if (tracingV2Enabled) {
          ...
          callbackManager._parentRunId = ((_a = tracerV2.getTraceableRunTree()) == null ? void 0 : _a.id) ?? callbackManager._parentRunId;
        }
      }
    }
...
function ensureConfig(config) {
  var _a;
  const implicitConfig = AsyncLocalStorageProviderSingleton2.getInstance().getStore();
  let empty = {
    tags: [],
    metadata: {},
    recursionLimit: 25,
...
var MAX_DATA_DISPLAY_NAME_LENGTH = 42;
...
@langchain/core/dist/utils/fast-json-patch/src/duplex.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WKFOUCAC.js.map
